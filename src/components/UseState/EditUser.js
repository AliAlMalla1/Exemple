...
const EditUser = () => {
    ...
    const handleEdit = (e) => {
        e.preventDefault();
        const user = {name,username,email,password,image,city,street,suite,lat,lng}
...
<div className="mb-6">
    ...
    <div className="mb-6">
      ...
      <input className="shadow  border  rounded w-full py-2.5 px-3 text-gray-700 mb-3 " id="phone" type="number" placeholder="phone" value={phone} onChange={(e) => setPhone(e.target.value)}/>
    </div>
    </div>
  ...
  <div className="mb-4">
    ...
    <div className="flex  justify-center">
      <button onClick={handleEdit} className="bg-blue-600   text-white font-bold py-2 px-6 mt-5 rounded border-2 border-blue-600 duration-500 hover:bg-white hover:text-blue-600" type="button">
       Edit
      </button>
