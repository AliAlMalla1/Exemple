...
<div className="mb-6">
  ...
  <div className="mb-4">
    ...
    <div className="flex  justify-center">
      <button onClick={handleEdit} className="bg-blue-600   text-white font-bold py-2 px-4 mt-5 rounded border-2 border-blue-600 duration-500 hover:bg-white hover:text-blue-600" type="button">
       Edit
      </button>
